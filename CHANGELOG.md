...
### Removed
### Fixed
- Fixed the `timeout` parameter being forwarded to the server when `request_timeout` is also passed ([#1110](https://github.com/opensearch-project/opensearch-py/pull/1110))
